...
The last results is especially surprising,
...
% DROP IN FEMALE RECIPIENTS, REMAIN LEVEL FOR MEN

\begin{table}[ht!]
\centering
\caption{Households with and without Male Pension Recipients}
\label{sa:ta:hmr}
    \begin{tabular}{l|rrrr}
    \hline
...
\begin{table}[ht!]
\centering
\caption{Households with and without Female Pension Recipients}
\label{sa:ta:fmr}
    \begin{tabular}{l|rrrr}
    \hline
    Year                & 2008   & 2012   & 2013   & Overall \\
