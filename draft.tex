\documentclass[a4paper,12pt]{report}\usepackage[]{graphicx}\usepackage[]{color}
...
\title{Preliminary Thesis Defence\\~\\ Supervisor: Jean-Louis Arcand\\ Second Reader: Love Vanderwalle}
