...
where equation (3.2) examines quantity and equation (3.3) quality of the social network. The measure for number of friends here is the number of POWs from the same company in Andersonville.
