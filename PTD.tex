...
This leads to a standard situation where there is a stable, unstable,
...
We can summarise the main problem with the model as follows:
\begin{enumerate}
...
\end{enumerate}
In the technical proof of the paper, we can pinpoint the non sequitur in two different but related points.
...
\end{quotation}
This should say ``...abandon the exchange rate \textit{always} if the observed fraction is great than or equal to...''. Since 
